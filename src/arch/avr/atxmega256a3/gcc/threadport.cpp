...
void ThreadPort::InitStack(Thread* pclThread_)
{
    ...
    PORT_PUSH_TO_STACK(pu8Stack, 0x00); // Highest byte?
    ...
    PORT_PUSH_TO_STACK(pu8Stack, 0x00); // PMIC CTRL
    ...
    PORT_PUSH_TO_STACK(pu8Stack, 0x3B); // RAMPZ    3B
    PORT_PUSH_TO_STACK(pu8Stack, 0x39); // RAMPX 39
    PORT_PUSH_TO_STACK(pu8Stack, 0x38); // RAMPD 38
    PORT_PUSH_TO_STACK(pu8Stack, 0x3C); // EIND  3C
