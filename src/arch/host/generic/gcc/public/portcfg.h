...
*/
#define KERNEL_NUM_PRIORITIES (64)
...
/**
    ...
    size.
*/
#define K_WORD uint64_t  //!< Size of a data word
#define K_ADDR uint64_t //!< Size of an address (pointer size)
#define K_INT int64_t
...
/**
    ...
    PORT_PROI_TYPE.
*/
#define PORT_PRIO_TYPE uint64_t      //!< Type used for bitmap in the PriorityMap class
#define PORT_PRIO_MAP_WORD_SIZE (8) //!< size of PORT_PRIO_TYPE in bytes
