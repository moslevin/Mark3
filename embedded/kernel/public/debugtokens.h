...
#define KPROFILE_CPP		0x0010		/* SUBSTITUTE="kernelprofile.cpp" */
#define THREADPORT_CPP		0x0011		/* SUBSTITUTE="threadport.cpp" */
#define TIMER_CPP           0x0012      /* SUBSTITUTE="timer.cpp" */
...
#define KPROFILE_H			0x1013		/* SUBSTITUTE="kernelprofile.h" */
