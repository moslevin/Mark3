...
public:
	...
	*/
	K_BOOL Pend( K_ULONG ulWaitTimeMS_);
...
private:
	...
	*/
     ...
     */
    K_BOOL Pend_i( K_ULONG ulWaitTimeMS_ );
#else
    /*!
     * \brief Pend_i
     *
    ...
    K_USHORT m_usValue;         //!< Current count held by the semaphore
    K_USHORT m_usMaxValue;      //!< Maximum count that can be held by this semaphore
