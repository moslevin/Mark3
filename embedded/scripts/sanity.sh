...
./FunkProgMono.exe ./stage/app/avr/atmega328p/gcc/kernel_sanity.hex /dev/ttyACM0 57600
#./FunkProgMono.exe ./stage/app/avr/atmega328p/gcc/kernel_sanity.hex COM5 57600

# Open the terminal, run profiling app for 30 seconds
./FunkTermMono.exe /dev/ttyACM0 57600 ASCII > ./sanity.txt &
#./FunkTermMono.exe COM5 57600 ASCII > ./sanity.txt &
pid=$!
sleep 60
kill ${pid}
