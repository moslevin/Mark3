...
void Breakout::GameTick()
{
    ...
    switch (m_eState) {
        case GAME_STATE_TITLE: TitleLoop(); break;
        case GAME_STATE_ATTRACT: AttractLoop(); break;
        case GAME_STATE_NEXT_LEVEL: break;
        case GAME_STATE_BALL_WAIT: break;
        case GAME_STATE_ACTIVE: GameLoop(); break;
        case GAME_STATE_LOSE_LIFE: break;
        case GAME_STATE_GAME_OVER: GameOverLoop(); break;
        case GAME_STATE_HIGH_SCORE: HighScoreLoop(); break;
        case GAME_STATE_LIST_SCORES: ListScoreLoop(); break;
        case GAME_STATE_BEGIN: TransitionToState(GAME_STATE_LIST_SCORES);
        default: break;
    }
}
...
void Breakout::TransitionToState(GameState_t eState_)
{
    ...
    switch (m_eState) {
        ...
        case GAME_STATE_ATTRACT: break;
        case GAME_STATE_NEXT_LEVEL: break;
        case GAME_STATE_BALL_WAIT: break;
        case GAME_STATE_ACTIVE: break;
        case GAME_STATE_LOSE_LIFE: break;
        case GAME_STATE_GAME_OVER: break;
        case GAME_STATE_HIGH_SCORE: break;
        case GAME_STATE_LIST_SCORES: break;
        default: break;
    }
    ...
    switch (eState_) {
        case GAME_STATE_TITLE: TitleEnter(); break;
        case GAME_STATE_ATTRACT: AttractLoopEnter(); break;
        case GAME_STATE_NEXT_LEVEL: break;
        case GAME_STATE_BALL_WAIT: break;
        case GAME_STATE_ACTIVE: GameEnter(); break;
        case GAME_STATE_LOSE_LIFE: break;
        case GAME_STATE_GAME_OVER: break;
        case GAME_STATE_HIGH_SCORE: break;
        case GAME_STATE_LIST_SCORES: ListScoreEnter(); break;
        default: break;
    }
}
//---------------------------------------------------------------------------
    ...
    if (!m_u16Counter) {
        ...
        do {
            ...
            if ((u16PixY > (PADDLE_YPOS - BALL_SIZE)) && (m_clBall.GetVelY() > 0)) {
                if (((u16PixX + BALL_SIZE - 1) >= m_clPaddle.GetLeft()) && (u16PixX <= m_clPaddle.GetRight())) {
...
void Breakout::TitleEnter()
{
    ...
    for (uint8_t u8Col = 0; u8Col < 10; u8Col++) {
        uint8_t u8Height;
        switch (u8Col) {
            case 0: u8Height = 7; break;
            case 1: u8Height = 3; break;
            case 2: u8Height = 6; break;
            case 3: u8Height = 4; break;
            case 4: u8Height = 8; break;
            case 5: u8Height = 2; break;
            case 6: u8Height = 5; break;
            case 7: u8Height = 1; break;
            case 8: u8Height = 4; break;
            case 9: u8Height = 7; break;
            default: break;
        }
