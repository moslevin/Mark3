    ...
    for (uint8_t i = 0; i < PADDLE_HEIGHT; i++) {
        if (m_u8Mode & PADDLE_MODE_LASER) {
            switch (i) {
                ...
                case 2:
                case 3: stLine.uColor = RGB_COLOR(MAX_RED, 0, MAX_BLUE); break;
                default: break;
            }
        } else {
            switch (i) {
                case 0:
                case 5: stLine.uColor = COLOR_GREY37; break;
                case 1:
                case 4: stLine.uColor = COLOR_GREY75; break;
                case 2:
                case 3: stLine.uColor = COLOR_WHITE; break;
                default: break;
            }
        }
