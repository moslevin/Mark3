...
public:
    ...
    */
    ...
    /*!
        ...
        \fn static K_BOOL CompareStrings( const char *szStr1_, const char *szStr2_ )

        \param szStr1_ First string to compare
        \param szStr2_ Second string to compare
        \return true if strings match, false otherwise.
    */
    static K_BOOL CompareStrings( const char *szStr1_, const char *szStr2_ );
    ...
    */
    ...
    /*!
        ...
        \fn static K_BOOL CompareMemory( void *pvMem1_, void *pvMem2_, K_USHORT usLen_ )
    ...
    */
    static K_BOOL CompareMemory( const void *pvMem1_, const void *pvMem2_, K_USHORT usLen_ );
