...
for test in test_list:
	load_cmd = "mono ./FunkProgMono.exe %s/app/%s/%s/%s/%s.hex %s %s" % (stage, platform, cpu, toolchain, test, device, baud)
	...
	test_cmd = "mono ./FunkTermMono.exe %s %s ASCII" % (device, baud)
