...
public:
    ...
    */
    static void
    Init(const char* pcDriverPath_, uint16_t u16RxSize_, uint8_t* aucRx_, uint16_t u16TxSize_, uint8_t* aucTx_);
    ...
    */
    ...
    /*!
        ...
        \param pclMessageQueue_ Pointer to the message queue to use for
               notification.
    */
    static void SetQueue(MessageQueue* pclMessageQueue_) { m_pclMessageQueue = pclMessageQueue_; }
    /*!
