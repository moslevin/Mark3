...
TEST(ut_timer_tolerance)
{
    ...
    // Test point - 1ms timer should be no more than 2ms
    ulTempTime *= 2;
    ...
    // Test point - 10ms timer should be no more than 11ms
    ulTempTime += SYSTEM_FREQ / 1000;
    EXPECT_LT(ulTimeVal, ulTempTime);
    ...
    // Test point - 100ms timer should be no more than 101ms
    ulTempTime += SYSTEM_FREQ / 1000;
    EXPECT_LT(ulTimeVal, ulTempTime);
    ...
    // Test point - 1000ms timer should be no more than 1001ms
    ulTempTime += SYSTEM_FREQ / 1000;
    EXPECT_LT(ulTimeVal, ulTempTime);
