...
public:
    ...
    void SetInterface(SERCOM_Interface_t eInterface_) { m_eInterface = eInterface_; }
    void SetMux(SERCOM_Mux_t eMux_) { m_eMux = eMux_; }
    void SetTxPad(SERCOM_Pad_t ePad_) { m_eTxPad = ePad_; }
    void SetRxPad(SERCOM_Pad_t ePad_) { m_eRxPad = ePad_; }
    void SetBaud(uint32_t u32Baud_) { m_u32Baud = u32Baud_; }
    void SetParity(bool bParity_) { m_bParity = bParity_; }
    void SetStopBits(uint8_t u8StopBits_) { m_u8StopBits = u8StopBits_; }
    void SetClockGen(ClockGenerator_t eClockGen_) { m_eClockGen = eClockGen_; }
    void SetBaudClock(uint32_t u32ClockHz_) { m_u32ClockFreqHz = u32ClockHz_; }
    void                       Open(void);
