...
uint8_t DCPU::GetOperand(uint8_t uCopType_, uint16_t** pu16Result_)
{
    ...
    switch (uCopType_) {
        ...
        case ARG_Z:
        case ARG_I:
        case ARG_J: *pu16Result_ = &m_stRegisters.au16Registers[uCopType_ - ARG_A]; break;
        ...
        case ARG_BRACKET_Z:
        case ARG_BRACKET_I:
        case ARG_BRACKET_J: *pu16Result_ = &m_pu16RAM[m_stRegisters.au16Registers[uCopType_ - ARG_BRACKET_A]]; break;
        ...
        case ARG_SP: *pu16Result_ = &(m_stRegisters.SP); break;
        case ARG_PC: *pu16Result_ = &(m_stRegisters.PC); break;
        case ARG_EX: *pu16Result_ = &(m_stRegisters.EX); break;
        case ARG_NEXT_WORD:
