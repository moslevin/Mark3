...
void SysTC::SetupRegisters()
{
    ...
    WriteSync();
    m_pstTC->COUNT32.CTRLA.reg = u32CtrlA;
    WriteSync();
    m_pstTC->COUNT32.CTRLBSET.reg = u32CtrlB;
    WriteSync();
    m_pstTC->COUNT32.CTRLC.reg = u32CtrlC;
    WriteSync();
    m_pstTC->COUNT32.READREQ.reg = u32ReadReq;
    WriteSync();
    m_pstTC->COUNT32.EVCTRL.reg = u32EventCtrl;
}
