...
uint16_t              TraceBuffer::m_u16SyncNumber; //!< Current packet synchronization number
uint16_t              TraceBuffer::m_u16Index;      //!< Current buffer index
uint16_t              TraceBuffer::m_au16Buffer[(TRACE_BUFFER_SIZE / sizeof(uint16_t))]; //!< Data buffer
