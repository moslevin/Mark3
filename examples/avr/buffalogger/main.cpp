...
# error "Buffalogger demo requires tracebuffer support"
#endif
...
volatile uint16_t* pu16Log;
volatile uint16_t  u16LogLen;
...
#endif //#if KERNEL_USE_DEBUG && !KERNEL_AWARE_SIMULATION
