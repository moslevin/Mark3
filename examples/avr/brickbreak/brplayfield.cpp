...
const uint16_t au16LevelData[][LEVEL_NUM_ROWS] LEVEL_MEM
    = { { 0xFFF, 0xFFF, 0x666, 0x666, 0x666, 0x666, 0x666, 0x666, 0xFFF, 0xFFF },
        { 0xF81, 0xF18, 0x7E, 0x9FF, 0xFFF, 0xFFF, 0xFE7, 0xF81, 0x63C, 0x7E },
        { 0x1, 0xFFD, 0x805, 0xBF5, 0xA15, 0xAF5, 0xA05, 0xBFD, 0x801, 0xFFF },
        { 0x198, 0x198, 0x3FC, 0x3FC, 0x7FE, 0x7FE, 0x3FC, 0x3FC, 0x198, 0x198 },
        { 0xF0, 0x1F8, 0x3FC, 0x36C, 0x3FC, 0x7FE, 0x7FE, 0x7FE, 0x108, 0x294 },
        { 0x36C, 0x76E, 0xC63, 0x861, 0xBFD, 0xBFD, 0x861, 0xC63, 0x76E, 0x36C },
        { 0x39C, 0x7FE, 0x7FE, 0x7FE, 0x7FE, 0x3FC, 0x1F8, 0xF0, 0x60, 0x0 },
        { 0x0, 0x7B6, 0xBB7, 0xBB6, 0xBB6, 0x7B6, 0x3F6, 0x36F, 0x0, 0xFFF },
        { 0xF6F, 0xE67, 0xEF7, 0xF0, 0xFFF, 0xFFF, 0xF0, 0xEF7, 0xE67, 0xF6F },
        { 0xF0, 0x3FC, 0x7FE, 0x666, 0x7FE, 0x7FE, 0x6F6, 0x70E, 0x3FC, 0xF0 },
        { 0xC63, 0x666, 0x666, 0x76E, 0x30C, 0xDFB, 0x30C, 0x76E, 0x666, 0xC63 },
        { 0xFFF, 0xFFF, 0xFFF, 0x7, 0xFF, 0xFF, 0x7, 0xFFF, 0xFFF, 0xFFF },
        { 0xFC1, 0xFE3, 0x877, 0x877, 0xF7F, 0xF5D, 0x85D, 0x85D, 0xFDD, 0xFDD },
        { 0xFFF, 0x0, 0xFFF, 0x0, 0xFFF, 0x0, 0xFFF, 0x0, 0xFFF, 0x0 },
        { 0xC03, 0xC63, 0xD6B, 0xCF3, 0xDFB, 0xCF3, 0xCF3, 0xDFB, 0xD6B, 0xC63 },
        { 0xFFF, 0x7FF, 0x383, 0x1C3, 0xE3, 0xC70, 0xC38, 0xC1C, 0xFFE, 0xFFF },
        {
            0xC, 0x1E, 0xC, 0x0, 0x7FE, 0xFFF, 0xFFF, 0xFFF, 0xFFF, 0x7FE,
        },
        { 0x1C7, 0x5D7, 0x1C7, 0xE38, 0xEBA, 0xE38, 0x1C7, 0x5D7, 0x1C7, 0xFFF },
        { 0x444, 0x666, 0x626, 0xEEE, 0xFFF, 0xFFF, 0x777, 0x666, 0x666, 0x222 },
        { 0x3DC, 0x7FE, 0xFFF, 0xF0F, 0xE07, 0x6F6, 0xF0, 0x60, 0x0, 0x0 },
        { 0x0EEE, 0x0777, 0x0BBB, 0x0DDD, 0x0EEE, 0x0777, 0x0BBB, 0x0DDD, 0x0EEE, 0x0777 },
        { 0x07FE, 0x03FC, 0x09F9, 0x0CF3, 0x0E67, 0x0F0F, 0x0E67, 0x0CF3, 0x09F9, 0x03FC },
        { 0x0FFF, 0x0999, 0x0999, 0x0999, 0x0FFF, 0x0666, 0x0666, 0x0666, 0x0FFF, 0 },
        { 0x0F0F, 0x0F0F, 0x0F9F, 0x0F9F, 0x0FFF, 0x0FFF, 0x0F6F, 0x0F6F, 0x0F0F, 0x0F0F },
        { 0x0007, 0x000F, 0x001F, 0x003F, 0x007F, 0x00FF, 0x01FF, 0x03FF, 0x07FF, 0x0FFF },
        { 0x0FFF, 0x0801, 0x0BFD, 0x0FFF, 0, 0x0FFF, 0x0BFD, 0x0801, 0x0FFF, 0 },
        { 0x0FFF, 0x0FFF, 0x0FFF, 0x0FFF, 0x0FFF, 0x0FFF, 0x0FFF, 0x0FFF, 0x0FFF, 0x0FFF },
        { 0x0BFD, 0x0BFD, 0x0BFD, 0x0BFD, 0, 0, 0x0BFD, 0x0BFD, 0x0BFD, 0x0BFD },
        { 0x0FFF, 0x0FFF, 0x0C03, 0x0C03, 0x0CF3, 0x0CF3, 0x0C03, 0x0C03, 0x0FFF, 0x0FFF },
        { 0x0AAA, 0x0555, 0x0AAA, 0x0555, 0x0AAA, 0x0555, 0x0AAA, 0x0555, 0x0AAA, 0x0555 },
...
static BrLevelType_t aeLevelTypes[NUM_LEVELS]
    = { BR_LEVEL_NORMAL,   BR_LEVEL_NORMAL,   BR_LEVEL_BREAKTHROUGH, BR_LEVEL_ROULETTE,
        ...
        BR_LEVEL_ROULETTE, BR_LEVEL_NORMAL,   BR_LEVEL_BREAKTHROUGH, BR_LEVEL_ROULETTE,
        BR_LEVEL_NORMAL,   BR_LEVEL_NORMAL,   BR_LEVEL_BREAKTHROUGH, BR_LEVEL_NORMAL,
        BR_LEVEL_ROULETTE, BR_LEVEL_NORMAL,   BR_LEVEL_BREAKTHROUGH, BR_LEVEL_NORMAL,
        BR_LEVEL_NORMAL,   BR_LEVEL_ROULETTE, BR_LEVEL_BREAKTHROUGH, BR_LEVEL_NORMAL };
...
bool BrPlayField::CheckBrickExists(uint16_t u16X_, uint16_t u16Y_)
{
    ...
    if (u16Y_ < (PLAYFIELD_BRICK_MARGIN + HUD_HEIGHT + PLAYFIELD_BORDER_HEIGHT)) {
        return false;
               ...
               >= ((PLAYFIELD_BRICK_MARGIN + HUD_HEIGHT + PLAYFIELD_BORDER_HEIGHT) + (LEVEL_NUM_ROWS * BRICK_HEIGHT))) {
        return false;
    }
...
void BrPlayField::LevelAction(uint8_t u8Flags_)
{
    ...
    switch (m_clLevelData.eLevelType) {
        case BR_LEVEL_ROULETTE:
            if ((u8Flags_ == LEVEL_ACTION_PADDLE_HIT) || (u8Flags_ == LEVEL_ACTION_WALL_HIT)
    ...
    if ((m_u16TickCount & 0x01FF) == 0x000F) {
        ...
        while (u8Retries--) {
            if (m_clLevelData.au16Data[u8Row % LEVEL_NUM_ROWS] & (1 << (uint16_t)(u8Col % LEVEL_NUM_COLS))) {
                SetBonus((u8Row % LEVEL_NUM_ROWS) + 1, (u8Col % LEVEL_NUM_COLS) + 1);
                break;
            }
...
void BrPlayField::DrawBrick(uint8_t u8Row_, uint8_t u8Col_, uint8_t u8Mode_)
{
    ...
    if (!u8Mode_) {
        switch (u8Row_) {
            case 0:
            case 1: uColor = RGB_COLOR(0, 4 * MAX_GREEN / 5, 0); break;
            case 2:
            case 3: uColor = RGB_COLOR(0, 0, 4 * MAX_BLUE / 5); break;
            case 4:
            case 5: uColor = RGB_COLOR(4 * MAX_RED / 5, 4 * MAX_GREEN / 5, 0); break;
            case 6:
            case 7: uColor = RGB_COLOR(4 * MAX_RED / 5, 2 * MAX_GREEN / 5, 0); break;
            case 8:
            case 9: uColor = RGB_COLOR(4 * MAX_RED / 5, 0, 4 * MAX_BLUE / 5); break;
            default: break;
        }
    } else {
        uColor = COLOR_GREY75;
    ...
    if (!u8Mode_) {
        switch (u8Row_) {
            case 0:
            case 1: uColor = RGB_COLOR(0, MAX_GREEN / 2, 0); break;
            case 2:
            case 3: uColor = RGB_COLOR(0, 0, MAX_BLUE / 2); break;
            case 4:
            case 5: uColor = RGB_COLOR(MAX_RED / 2, MAX_GREEN / 2, 0); break;
            case 6:
            case 7: uColor = RGB_COLOR(MAX_RED / 2, MAX_GREEN / 4, 0); break;
            case 8:
            case 9: uColor = RGB_COLOR(MAX_RED / 2, 0, MAX_BLUE / 2); break;
            default: break;
        }
    } else {
        uColor = COLOR_GREY50;
    ...
    if (!u8Mode_) {
        switch (u8Row_) {
            case 0:
            case 1: uColor = RGB_COLOR(0, MAX_GREEN, 0); break;
            case 2:
            case 3: uColor = RGB_COLOR(0, 0, MAX_BLUE); break;
            case 4:
            case 5: uColor = RGB_COLOR(MAX_RED, MAX_GREEN, 0); break;
            case 6:
            case 7: uColor = RGB_COLOR(MAX_RED, MAX_GREEN / 2, 0); break;
            case 8:
            case 9: uColor = RGB_COLOR(MAX_RED, 0, MAX_BLUE); break;
            default: break;
        }
    } else {
        uColor = COLOR_WHITE;
