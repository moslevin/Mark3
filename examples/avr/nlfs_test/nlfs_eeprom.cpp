...
{
    NLFS_Node_t* pstFileNode = (NLFS_Node_t*)(m_puHost->kaData + (u16Node_ * sizeof(NLFS_Node_t)));
...
{
    NLFS_Block_t* pstFileBlock
        = (NLFS_Block_t*)(m_puHost->kaData + m_stLocalRoot.u32BlockOffset + (u32Block_ * sizeof(NLFS_Block_t)));
...
{
    const void* pvAddr = (const void*)(m_puHost->kaData + m_stLocalRoot.u32DataOffset + u32Offset_
...
{
    void* pvAddr = (void*)(m_puHost->kaData + m_stLocalRoot.u32DataOffset + u32Offset_
                           + (u32Block_ * m_stLocalRoot.u32BlockSize));
